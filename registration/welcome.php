            ...
            <form method='POST' action='update_profile.php' style='font-size: 100%;'>
                ...
                <div class='row'>
                    ...
                    <div class='col-md-3 border-right'>
                        ...
                        <span class='text-black-50'><?php echo $mobileNumber;?></span>
                    ...
                    <div class='col-md-5 border-right'>
                        ...
                        <div class='p-3 py-5'>
                            ...
                            <div class='row mt-2'>
                                ...
                                <div class='col-md-6'><label style='font-size: 120%;' class='labels mt-4'>Full Name</label><input style='font-size: 100%;' type='text' class='form-control mt-2' name='new_name' value='<?php echo $name;?>'></div>

                            </div>

                            <div class='row mt-3'>

                                <div class='col-md-12'><label style='font-size: 120%;' class='labels mt-3'>Mobile Number</label><input style='font-size: 100%;' type='text' class='form-control mt-2' name='new_mobile_number' value='<?php echo $mobileNumber;?>'></div>
...
if (mysqli_num_rows($query) > 0) {
    ...
    $restaurantAdded = $row['restaurant_added'];

    // Display appropriate button based on the value of restaurant_added
    if ($restaurantAdded == 1) {
        // User has added a restaurant, so show the "View Restaurant" button
        ?>
        <a class="btn btn-primary profile-button mt-3" href="./admin_panel/admin_panel/index.php" style="font-size: 100%;">View Restaurant</a>
        <?php
    } else {
        // User has not added a restaurant, so show the "Add Restaurant" button
        ?>
        <a class="btn btn-primary profile-button mt-3" href="add_restaurant.php" style="font-size: 100%;">Add Restaurant</a>
        <?php
    }
}
?>

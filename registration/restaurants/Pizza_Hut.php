    ...
    while ($innerRow = $result->fetch_assoc()) {
        ...
        <div class="preview" data-target="p-<?php echo $innerCount; ?>">
            ...
            <div class="quantity-changer">
                <button class="decrease-quantity" onclick="decreaseQuantity(<?php echo $innerRow['product_id']; ?>)">-</button>
                <input type="number" class="product-quantity" data-target="p-<?php echo $innerRow['product_id']; ?>" value="1" min="1">
                <button class="increase-quantity" onclick="increaseQuantity(<?php echo $innerRow['product_id']; ?>)">+</button>
            </div>
            ...
            <div class="buttons">
                ...
                <button onclick="addToCart(<?php echo $innerRow['product_id']; ?>)">Add to Plate</button>

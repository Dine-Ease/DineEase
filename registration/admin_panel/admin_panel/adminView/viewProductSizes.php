...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT * from product_size_variation v, product p, sizes s WHERE p.product_id=v.product_id AND v.size_id=s.size_id AND v.email = '{$_SESSION['SESSION_EMAIL']}'";
            ...
            <div class="form-group">
              ...
              <select name="size" >
                ...
                <?php
                  ...
                  $sql="SELECT * from sizes WHERE email = '{$_SESSION['SESSION_EMAIL']}'";
